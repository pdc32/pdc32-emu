...
.PHONY: web
web:
	EM_CACHE=$(PWD)/.emscripten_cache/ emmake make BIN_EXT=".js" CXXFLAGS="-sUSE_SDL=2 -sTOTAL_MEMORY=67108864 -sEXPORTED_FUNCTIONS=['_keyboard_paste_text'] -sEXPORTED_RUNTIME_METHODS=['ccall'] --preload-file firmware/ --preload-file font/ --preload-file res/"
